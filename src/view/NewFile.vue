<template>
    <div>
    			<app-header :ltitle='"后退"' :ctitle='"新增档案"'></app-header>
    		
    		<ul class="tab clearfix">
    			<li class="active edit"><p> <i class="icon"></i> 人工输入</p></li>
    			<li class="ocr">	<p><i class="icon"></i>OCR识别</p> </li>
    		</ul>
...
>>>>>>> c811fa5e21ae3ee92878695f00877f5740e8ed16
	    			</div>
    			 </div>
