...
export default {
    run(fun, params, success, error = 'window.$error') {
        ...
        if (fun == 'getDeviceInfo') {
            ...
            data = { "state": "0", "message": "当前最新版本号：2.2", "newestVersionNo": "2.2", "versionUrl": "null20181104\lombok.jar" }
        }
